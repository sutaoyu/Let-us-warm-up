...
- [kdsec 技术栈上手白皮书](#kdsec-技术栈上手白皮书)
- [概述](#概述)
  - [目的](#目的)
  - [岗位划分](#岗位划分)
- [基础知识](#基础知识)
  - [shell 基础知识](#shell-基础知识)
  - [常见linux命令](#常见linux命令)
  ...
  - [Git 基础知识](#git-基础知识)
    ...
    - [学习资源](#学习资源-1)
    - [常见git 命令](#常见git-命令)
  - [vim 基础使用知识](#vim-基础使用知识)
  - [组内API管理](#组内api管理)
  - [组内 API 编写规范](#组内-api-编写规范)
- [前端](#前端)
  - [必须学会的知识点](#必须学会的知识点-2)
  - [拔高知识点](#拔高知识点-2)
  - [学习资源](#学习资源-2)
  - [额外的建议](#额外的建议)
  - [学习能力评价](#学习能力评价)
    - [任务1：实现kdsec小组博客前端页面](#任务1实现kdsec小组博客前端页面)
- [后端](#后端)
  - [必须学会的知识点](#必须学会的知识点-3)
  - [拔高知识点](#拔高知识点-3)
  - [学习资源](#学习资源-3)
  - [额外的建议](#额外的建议-1)
  - [学习能力评价](#学习能力评价-1)
    - [任务1：实现任一领域的图谱检索与存储服务](#任务1实现任一领域的图谱检索与存储服务)
- [算法](#算法)
  - [必须学会的知识点](#必须学会的知识点-4)
  - [拔高知识点](#拔高知识点-4)
  - [学习资源](#学习资源-4)
...
# 结语
- 本文版权由中国科学院信息工程研究所第五研究室kdsec小组所有，未经允许禁止任何其它形式的使用
- 本文各部分内容由下列kdsec小组成员提供了建设性意见，向各位表示诚挚的感谢（排名不分前后，以拼音顺序为准）：
    -  基础知识：苏涛宇
    -  前端部分：李彦增、穆红章
    -  后端部分：从鑫、王玉斌
    -  算法部分：王栋、郁博文、张振宇
- 本文内容由kdsec小组成员苏涛宇进行归纳整理，受时间和能力限制，难免有不足之处，欢迎大家批评指正。
